...
+ (NSNumber *)tempFarToCelcius:(NSNumber *) tempFar {
    
    return @((tempFar.floatValue - 32) * 5/9);
}

+ (NSNumber *)tempCelsiusToFahrenheit:(NSNumber *) tempCelsius {
    
    return @((tempCelsius.floatValue * 9/5) + 32);
}

+ (NSNumber *)tempKelvinToCelcius:(NSNumber *) tempKelvin {
    
    return @(tempKelvin.floatValue - 273.15);
}

+ (NSNumber *)tempKelvinToFahrenheit:(NSNumber *) tempKelvin {
...
- (NSNumber *)convertTemp:(NSNumber *) temp {
    ...
    if (_currentTemperatureFormat == kOWMTempCelcius) {
        return [OWMWeatherAPP tempKelvinToCelcius:temp];
    } else if (_currentTemperatureFormat == kOWMTempFahrenheit) {
        return [OWMWeatherAPP tempKelvinToFahrenheit:temp];
    } else {
        return temp;
    }
}
